...
public class SendSMPTMail {
	...
	public static void main(String[] args) {
		...
		String username = "bmjrowe@gmail.com";
		String password = "";
		...
		try {
			...
			message.setFrom(new InternetAddress("bmjrowe@live.com"));
			message.setRecipients(Message.RecipientType.TO,
					InternetAddress.parse("bradleyrowe@live.com"));
